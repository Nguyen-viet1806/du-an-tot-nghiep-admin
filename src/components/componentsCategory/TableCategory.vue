              ...
              <td>
                <div class="form-switch">
                  <input
                    ...
                    @change="updateCategoryParenStatus(CategoryParent, $event)"
                    :checked="
...
export default {
  ...
  watch: {
    ...
    pageableChild() {
      if (this.$store.state.categoryModule.categoryParent) {
        this.$emit(
          "getListFollowPageChild",
          this.$store.state.categoryModule.categoryParent.idCategory
        );
      }
    },
  },
  ...
  methods: {
    ...
    getSttChild(index) {
      return this.pageableChild !== 0
        ? index + this.pageableChild * 5 + 1
        : index + 1;
    },
    getListSort(sort = -1) {
      ...
      this.$store.dispatch(
        "categoryModule/getDanhSachCategoryParentSort",
        payload
      );
    },
    search() {
